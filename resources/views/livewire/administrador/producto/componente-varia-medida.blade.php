                ...
                <div wire:key="medida-{{ $medida->id }}">
                    <div>
                        ...
                        <div>
                            ...
                            <button wire:click="$emit('eliminarPivotMedidaModal', {{ $medida->id }})">
                                <span><i class="fa-solid fa-trash" style="color: red;"></i></span>Eliminar</button>
                        </div>
                    </div>
                    @livewire('administrador.producto.varia-medida-stock', ['medida' => $medida], key('varia-medida-stock-' . $medida->id . '-' . $index))
                </div>
                <br>
            @endforeach
        </div>
                ...
                <div class="formulario">
                    ...
                    <div class="contenedor_1_elementos_100">
                        <label class="label_principal">
                            <p class="estilo_nombre_input">Nombre medida: </p> 
                            <input type="text"
                                wire:model.defer="nombre_editado" placeholder="Ingrese nombre medida.">
