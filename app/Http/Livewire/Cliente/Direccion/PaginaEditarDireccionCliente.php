...
class PaginaEditarDireccionCliente extends Component
{
    ...
    {
        return view('livewire.cliente.direccion.pagina-editar-direccion-cliente')->layout('layouts.cliente.cliente');
    }
}
